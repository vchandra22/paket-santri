        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl font-bold">{isEditMode ? 'Edit Data Santri' : 'Tambah Data Santri'}</h1>
                </div>

                <div>
                    <h4 className="text-lg">Form Data Santri</h4>
                </div>
                <div>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                {errors.total_paket_diterima && <p className="text-sm text-red-500">{errors.total_paket_diterima}</p>}
                            </div>
                        </div>
